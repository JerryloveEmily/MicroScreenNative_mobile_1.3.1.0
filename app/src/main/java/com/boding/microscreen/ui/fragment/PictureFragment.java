...
public class PictureFragment extends BaseFragment implements View.OnClickListener {
     ...
     * @return
     */
    public static PictureFragment newInstance(String params) {
...
//                mCurrentPosition = 0;
        ...
        String url = String.format(AppConstants.PICTURE_URL, mActivity.validateCode);
    ...
    private static class MyRunnable implements Runnable {
        WeakReference<PictureFragment> weakActivity;

        public MyRunnable(PictureFragment fragment) {
            weakActivity = new WeakReference<PictureFragment>(fragment);
        }

        @Override
        public void run() {
            PictureFragment outClass = weakActivity.get();
            if (outClass != null) {
    ...
    private class ListInfoAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ListInfoAdapter(ArrayList<ImageInfo> imageInfos) {
            this.mImageInfos = (imageInfos == null ? new ArrayList<ImageInfo>() : new ArrayList<ImageInfo>(imageInfos));
        }
